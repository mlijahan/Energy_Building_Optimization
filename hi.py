...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBox_3.setGeometry(QtCore.QRect(240, 100, 111, 24))
        self.comboBox_3.setObjectName("comboBox_3")
        self.comboBox_3.addItem("")
        self.comboBox_3.addItem("")
        self.comboBox_3.addItem("")
        self.label_4 = QtWidgets.QLabel(parent=Dialog)
        self.label_4.setGeometry(QtCore.QRect(30, 102, 181, 16))
        font = QtGui.QFont()
        font.setBold(True)
    ...
    def surface_heat(self):
        self.surface_position = self.comboBox_4.currentIndex()
        self.surface_emittance = self.comboBox_3.currentIndex()
        if self.surface_position == 0:
            if self.surface_emittance == 0:
                self.h_inside = 9.26
            elif self.surface_emittance == 1:
                self.h_inside = 5.17
            else:
                self.h_inside = 4.32
        if self.surface_position == 1:
            if self.surface_emittance == 0:
                self.h_inside = 9.09
            elif self.surface_emittance == 1:
                self.h_inside = 5
        ...
        if self.surface_position == 4:
            if self.surface_emittance == 0:
                ...
                self.h_inside = 1.25
        return self.h_inside

    def reset_position_surface(self):
        return self.comboBox_4.setCurrentIndex(0)

    def reset_surface_emittance(self):
        return self.comboBox_3.setCurrentIndex(0)

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", " indoor surface heat transfer coefficient"))
        self.pushButton.setText(_translate("Dialog", "Clear"))
        self.pushButton_2.setText(_translate("Dialog", "Save"))
        self.label.setText(_translate("Dialog", "Position of Surface :"))
        self.comboBox_3.setItemText(0, _translate("Dialog", "0.09 (None-Reflective)"))
        self.comboBox_3.setItemText(1, _translate("Dialog", "0.2 (Reflective)"))
        self.comboBox_3.setItemText(2, _translate("Dialog", "0.05 (Reflective)"))
        self.label_4.setText(_translate("Dialog", "Surface Emittance :"))
        self.comboBox_4.setItemText(0, _translate("Dialog", "Horizontal-Upward"))
        self.comboBox_4.setItemText(1, _translate("Dialog", "Sloping 45_Upward"))
        self.comboBox_4.setItemText(2, _translate("Dialog", "Vertical-Horizontal"))
        self.comboBox_4.setItemText(3, _translate("Dialog", "Horizontal-Downward"))
        self.comboBox_4.setItemText(4, _translate("Dialog", "Sloping 45-Downward"))
