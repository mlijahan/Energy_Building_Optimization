...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(40, 40, 671, 86))
    ...
    def reset_depth_through_soil(self):
        return self.comboBox.setCurrentIndex(0)

    def reset_r_wall(self):
        return self.comboBox_2.setCurrentIndex(0)

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Heat Loss Coefficient"))
        self.label.setText(_translate("Dialog", "Depth& Path Length Through Soil (m)  :"))
        self.comboBox.setItemText(0, _translate("Dialog", "0<x<0.3"))
        self.comboBox.setItemText(1, _translate("Dialog", "0.3<x<0.45"))
        self.comboBox.setItemText(2, _translate("Dialog", "0.45<x<0.6"))
        self.comboBox.setItemText(3, _translate("Dialog", "0.6<x<0.75"))
        self.comboBox.setItemText(4, _translate("Dialog", "0.75<x<0.9"))
        self.comboBox.setItemText(5, _translate("Dialog", "0.9<x<1.05"))
        self.comboBox.setItemText(6, _translate("Dialog", "1.05<x<1.2"))
        self.comboBox.setItemText(7, _translate("Dialog", "1.2<x<1.35"))
        self.comboBox.setItemText(8, _translate("Dialog", "1.35<x<1.5"))
        self.comboBox.setItemText(9, _translate("Dialog", "1.5<x<1.65"))
        self.comboBox.setItemText(10, _translate("Dialog", "1.65<x<1.8"))
        self.comboBox.setItemText(11, _translate("Dialog", "1.8<x<1.95"))
        self.comboBox.setItemText(12, _translate("Dialog", "1.95<x<2.1"))
        self.label_3.setText(_translate("Dialog", "R of The Wall (W/m2k) :"))
        self.comboBox_2.setItemText(0, _translate("Dialog", "Uninsulated"))
        self.comboBox_2.setItemText(1, _translate("Dialog", "0.73"))
        self.comboBox_2.setItemText(2, _translate("Dialog", "1.47"))
        self.comboBox_2.setItemText(3, _translate("Dialog", "2.2"))
        self.label_2.setText(_translate("Dialog", "Wall Area Underground (m2) :"))
